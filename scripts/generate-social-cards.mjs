...
const cards = [
  ...
  },
  {
    ...
    title: "The Vellis thesis: memory, reasoning, review",
    description:
      "Why graph-native infrastructure lets systems remember, models reason, and humans ratify work without surrendering context.",
    kicker: "Thesis",
    shortTitle: "Memory\nReason\nReview",
    alt: "Three large connected nodes representing memory, reasoning, and review.",
    motif: "thesis",
  },
  {
    ...
    description:
      "Essays and field notes on typed context graphs, open agent memory, provenance, controls, and governed operations.",
    kicker: "Perspectives",
  ...
  {
    page: "/perspectives/legibility-wedge.html",
    filename: "perspective-legibility-wedge.png",
    title: "Legibility is the wedge for agentic software",
    description:
      "Agents become more useful when the system can show them what things mean, how they relate, and which changes require judgment.",
    kicker: "Perspective",
    shortTitle: "Legibility",
    alt: "An orange wedge revealing graph context.",
    motif: "wedge",
  },
  {
    page: "/perspectives/domain-explorations-matter.html",
    filename: "perspective-domain-explorations-matter.png",
    title: "Why domain explorations matter",
    description:
      "A field note on worked models as the bridge between abstract infrastructure and practical adoption.",
    kicker: "Perspective",
    shortTitle: "Domain models",
    alt: "A worked model bridge connecting infrastructure to adoption.",
    motif: "domain-article",
  },
  {
    page: "/perspectives/no-rug-pull-license.html",
    filename: "perspective-no-rug-pull-license.png",
    ...
    kicker: "Perspective",
    shortTitle: "No lock-in",
    alt: "An open license node connected to export and support paths.",
    motif: "license",
  },
];
