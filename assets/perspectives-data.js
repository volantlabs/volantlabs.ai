window.PERSPECTIVE_POSTS = [
  {
    ...
    related: ["runtime-controls", "open-data"]
  },
  {
    ...
    related: ["graph-theory", "open-data"]
  },
  {
    slug: "open-data",
    ...
    tags: ["Open engine", "Portability", "Compounding intelligence"],
    body: [
      {
    ...
    related: ["no-rug-pull-license", "runtime-controls"]
  },
  {
    ...
    provenanceLine: "By Eddie Austin",
    statusLabel: "Human essay",
    tags: ["Agents", "Legibility", "Human judgment"],
    body: [
      {
    ...
    related: ["graph-theory", "runtime-controls"]
  },
  {
    ...
    provenanceLine: "Drafted from the graph · Exploration",
    statusLabel: "Exploration",
    tags: ["Domain packs", "Adoption", "Worked models"],
    body: [
      {
    ...
    related: ["open-data", "legibility-wedge"]
  },
  {
    ...
    related: ["open-data", "domain-explorations-matter"]
  }
];

window.PERSPECTIVE_MANIFEST = {
  schemaVersion: "2026-06-18.perspectives.v1",
  sourceSpecs: [
    {
